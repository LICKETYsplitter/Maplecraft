...
public class EvaporatorMenu extends AbstractContainerMenu {
    ...
    public EvaporatorMenu(int pContainerID, Inventory inv, BlockEntity entity, ContainerData data, ContainerData panData){
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(iItemHandler -> {
            ...
            this.addSlot(new SlotItemHandler(iItemHandler, 1, 17, 56));
            this.addSlot(new SlotItemHandler(iItemHandler, 2, 143, 17));
            this.addSlot(new SlotItemHandler(iItemHandler, 3, 143, 56));
            this.addSlot(new SlotItemHandler(iItemHandler, 4, 80, 64));
        });
