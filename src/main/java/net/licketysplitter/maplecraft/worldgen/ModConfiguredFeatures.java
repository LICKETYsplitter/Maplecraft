...
public class ModConfiguredFeatures {
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context){
        ...
        register(context, SUGAR_MAPLE_KEY, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(
                BlockStateProvider.simple(ModBlocks.MAPLE_LOG.get()),
                new StraightTrunkPlacer(5, 4,3),
                BlockStateProvider.simple(ModBlocks.SUGAR_MAPLE_LEAVES.get()),
                new BlobFoliagePlacer(ConstantInt.of(2), ConstantInt.of(4), 3),
                new TwoLayersFeatureSize(1, 0, 2)).build());
    }
